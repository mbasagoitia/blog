...
function Filter ({ setFilteredPosts, blogPosts, filter, setSearchTerms }) {
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        if (search) {
            setFilteredPosts(filter(blogPosts, search));
    ...
    return (
        <Form onSubmit={(e) => {handleSearch(e)}}>
            ...
            <div className="input-group m-auto" id="search-wrapper">
                <div id="filter-search-btn" className="input-group-prepend">
